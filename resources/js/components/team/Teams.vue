        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body table-responsive p-0">
              <vue-good-table ref="table" :key="componentKey" :columns="columns" :rows="rows" :pagination-options="{
                enabled: true,
              }" :search-options="{
  enabled: true,
}">
            ...
            ">
              ...
              <div v-if ="editmode" class="col-sm-12">
                <div class="form-group input-group input-group-sm">
                  ...
                  <multiselect v-model="form.selected_users" :multiple="true" :max-height="200"
                    :options="users.map((user) => user.id)" :custom-label="
                      (opt) =>
                    ...
                    <template slot="selection" slot-scope="{
                        ...
                        v-if="values.length > 3 &amp;&amp; !isOpen">{{ values.length }} users
...
export default {
  ...
  methods: {
    editModal(row) {
      ...
      $("#addNew").modal("show");
      this.form.fill(row);
      this.form.selected_users=row.assigned_users.map(user=>user.id);
    },
    newModal() {
      this.editmode = false;
      this.form.reset();
