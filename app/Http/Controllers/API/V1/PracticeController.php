...
class PracticeController extends BaseController
{
    ...
    public function listing()
    {
        if (!Gate::allows('isAdmin')) {
            $this->practice = Auth::user()->assigned_practices();
            $practices = $this->practice->select("practice_name", "practices.id")->get();
        } else
    ...
    public function store(PracticeRequest $request)
    {
        $practice = $this->practice->create([
            ...
            'clearing_house_name' => $request->get('clearing_house_name'),
            'clearing_house_user' => $request->get('clearing_house_user'),
            'clearing_house_password' => $request->get('clearing_house_password'),
            'rr_ptan' => $request->get('rr_ptan'),
